...
# Femur
plt.subplot(3, 1, 1)
plt.plot(time_points, femur_angles[:, 0], label='X', color='r')
plt.plot(time_points, femur_angles[:, 1], label='Y', color='g')
plt.plot(time_points, femur_angles[:, 2], label='Z', color='b')
...
# Tibia
plt.subplot(3, 1, 2)
plt.plot(time_points, tibia_angles[:, 0], label='X', color='r')
plt.plot(time_points, tibia_angles[:, 1], label='Y', color='g')
plt.plot(time_points, tibia_angles[:, 2], label='Z', color='b')
...
# Patella
plt.subplot(3, 1, 3)
plt.plot(time_points, patella_angles[:, 0], label='X', color='r')
plt.plot(time_points, patella_angles[:, 1], label='Y', color='g')
plt.plot(time_points, patella_angles[:, 2], label='Z', color='b')
...
plt.plot(time_points, relative_angles[:, 0], label='X', color='r')
plt.plot(time_points, relative_angles[:, 1], label='Y', color='g')
plt.plot(time_points, relative_angles[:, 2], label='Z', color='b')
